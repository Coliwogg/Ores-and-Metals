...
public class ModItems {
    ...
    public static final RegistryObject<Item> RAW_DRAKOLITH = ITEMS.register("raw_drakolith", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> RAW_PHASMATITE = ITEMS.register("raw_phasmatite", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> ORIKALKUM_INGOT = ITEMS.register("orikalkum_ingot", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> NECRONIUM_INGOT = ITEMS.register("necronium_ingot", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> ORICHALCITE_SCRAP = ITEMS.register("orichalcite_scrap", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> NECRITE_SCRAP = ITEMS.register("necrite_scrap", () -> new Item(new Item.Properties()));

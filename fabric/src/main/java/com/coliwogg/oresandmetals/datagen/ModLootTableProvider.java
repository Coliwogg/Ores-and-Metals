...
public class ModLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        dropSelf(ModBlocks.ORIKALKUM_BLOCK.get());
        ...
        dropSelf(ModBlocks.RAW_DRAKOLITH_BLOCK.get());
        dropSelf(ModBlocks.RAW_PHASMATITE_BLOCK.get());
        dropSelf(ModBlocks.ORICHALCITE_DEBRIS.get());
        dropSelf(ModBlocks.NECRITE_DEBRIS.get());
        ...
        add(ModBlocks.NETHER_DRAKOLITH_ORE.get(), (block) -> createOreDrop(ModBlocks.NETHER_DRAKOLITH_ORE.get(), ModItems.RAW_DRAKOLITH.get()));
        add(ModBlocks.END_PHASMATITE_ORE.get(), (block) -> createOreDrop(ModBlocks.END_PHASMATITE_ORE.get(), ModItems.RAW_PHASMATITE.get()));
    }

    public LootTable.Builder createTinOreDrops(Block block) {
        HolderLookup.RegistryLookup<Enchantment> registryLookup = this.registries.lookupOrThrow(Registries.ENCHANTMENT);
        return this.createSilkTouchDispatchTable(block, this.applyExplosionDecay(block, LootItem.lootTableItem(ModItems.RAW_TIN.get()).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 5.0F))).apply(ApplyBonusCount.addOreBonusCount(registryLookup.getOrThrow(Enchantments.FORTUNE)))));
    }
}

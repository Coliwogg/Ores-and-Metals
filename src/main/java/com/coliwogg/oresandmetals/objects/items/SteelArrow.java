...
public class SteelArrow extends ArrowItem {
    ...
    public SteelArrow(Properties properties, float damageIn) {
        super(properties);
        this.damage = damageIn;
    }

    public SteelArrow setItemReference(RegistryObject<Item> referenceIn) {
        this.reference = referenceIn;
        return this;
    }

    @Override
    public SteelArrowEntity createArrow(World worldIn, ItemStack stack, LivingEntity shooter) {
        SteelArrowEntity arrowEntity = new SteelArrowEntity(reference.get(), shooter, worldIn);
